/****************************************************************************
** Meta object code from reading C++ file 'calibrationwindow.h'
**
...
#error "The header file 'calibrationwindow.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 28, 6) // "status"
    ...
    "CalibrationWindow\0sendData\0\0status"
};
...
void CalibrationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CalibrationWindow::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CalibrationWindow::sendData)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CalibrationWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CalibrationWindow.data,
      qt_meta_data_CalibrationWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CalibrationWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CalibrationWindow.stringdata0))
        return static_cast<void*>(const_cast< CalibrationWindow*>(this));
...
// SIGNAL 0
void CalibrationWindow::sendData(bool _t1)
{
